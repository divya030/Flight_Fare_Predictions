...
class Configuration:
    ...
    def get_data_validation_config(self) -> DataValidationConfig:
        try:
            ...
            report_file_path = os.path.join(artifact_dir_time_stamp,data_validation_info[DATA_VALIDATION_REPORT_FILE_NAME_KEY])

            report_page_file_path = os.path.join(artifact_dir_time_stamp,
